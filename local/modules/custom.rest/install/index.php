...
class custom_REST extends CModule
{
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("CUSTOM_REST_MODULE_NAME");
        $this->MODULE_DESCRIPTION = GetMessage("CUSTOM_REST_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("CUSTOM_REST_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("CUSTOM_REST_PARTNER_URI");
    }
