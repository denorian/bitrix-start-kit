...
if ($ACCESS >= "R") :
    ...
    $arAllOptions = array
    (
        array("", GetMessage("CUSTOM_REST_TITLE"), array("heading")),
    );

    $aTabs = array(
        array("DIV" => "edit1", "TAB" => GetMessage("MAIN_TAB_SET"), "ICON" => "T_settings", "TITLE" => GetMessage("MAIN_TAB_TITLE_SET")),
        array("DIV" => "edit3", "TAB" => GetMessage("MAIN_TAB_RIGHTS"), "ICON" => "T_settings", "TITLE" => GetMessage("MAIN_TAB_TITLE_RIGHTS")),
    );
